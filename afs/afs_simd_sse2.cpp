...
void __stdcall afs_analyze_12_sse2_plus2(BYTE *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
...
void __stdcall afs_analyze_1_sse2_plus2(BYTE *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
...
void __stdcall afs_analyze_2_sse2_plus2(BYTE *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
...
void __stdcall afs_merge_scan_sse2(BYTE* dst, BYTE* src0, BYTE* src1, int w, int si_w, int h, int x_start, int x_fin, int tb_order, int *stripe_count, AFS_SCAN_CLIP *mc_clip) {
    afs_merge_scan_simd(dst, src0, src1, si_w, h, x_start, x_fin);
}

void __stdcall afs_merge_scan_sse2_plus(BYTE* dst, BYTE* src0, BYTE* src1, int w, int si_w, int h, int x_start, int x_fin, int tb_order, int *stripe_count, AFS_SCAN_CLIP *mc_clip) {
