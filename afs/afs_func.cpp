...
static const struct {
	...
	{ SSE41|SSSE3|SSE2,     { 15, 16, BLOCK_SIZE_YCP, afs_analyze_set_threshold_sse2, NULL,                             { afs_analyze_12_sse4_1_plus2, afs_analyze_1_sse4_1_plus2, afs_analyze_2_sse4_1_plus2 } } },
	{ SSSE3|SSE2,           { 15, 16, BLOCK_SIZE_YCP, afs_analyze_set_threshold_sse2, NULL,                             { afs_analyze_12_ssse3_plus2,  afs_analyze_1_ssse3_plus2,  afs_analyze_2_ssse3_plus2  } } },
...
static const struct {
	...
	{ AVX2|AVX,             afs_blend_avx2   },
	{ AVX|SSE41|SSSE3|SSE2, afs_blend_avx    },
	{ SSE41|SSSE3|SSE2,     afs_blend_sse4_1 },
	{ SSE2,                 afs_blend_sse2   },
	{ NONE,                 afs_blend_mmx    },
};
...
static const struct {
	...
	{ AVX2|AVX, afs_mie_spot_avx2 },
	{ AVX|SSE2, afs_mie_spot_avx  },
	{ SSE2,     afs_mie_spot_sse2 },
	{ NONE,     afs_mie_spot_mmx  },
};
...
static const struct {
	...
	{ AVX2|AVX, afs_mie_inter_avx2 },
	{ AVX|SSE2, afs_mie_inter_avx  },
	{ SSE2,     afs_mie_inter_sse2 },
	{ NONE,     afs_mie_inter_mmx  },
};
...
static const struct {
	...
	{ AVX2|AVX,             afs_deint4_avx2   },
	{ AVX|SSE41|SSSE3|SSE2, afs_deint4_avx    },
	{ SSE41|SSSE3|SSE2,     afs_deint4_sse4_1 },
	{ SSE2,                 afs_deint4_sse2   },
	{ NONE,                 afs_deint4_mmx    },
};
...
static const struct {
	...
	{ AVX2|AVX,             afs_yuy2up_frame_avx2   },
	{ AVX|SSE41|SSSE3|SSE2, afs_yuy2up_frame_avx    },
	{ SSE41|SSSE3|SSE2,     afs_yuy2up_frame_sse4_1 },
	{ SSE2,                 afs_yuy2up_frame_sse2   },
	{ NONE,                 afs_yuy2up_frame_mmx    },
};
...
void get_afs_func_list(AFS_FUNC *func_list) {
	...
	for (int i = 0; i < _countof(FUNC_YUY2UP_LIST); i++) {
		if ((FUNC_YUY2UP_LIST[i].simd & simd_avail) == FUNC_YUY2UP_LIST[i].simd) {
			func_list->yuy2up = FUNC_YUY2UP_LIST[i].yuy2up;
			break;
		}
	}
