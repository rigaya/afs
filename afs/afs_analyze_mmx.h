...
static void __stdcall afs_analyze_12_mmx_plus2(unsigned char *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
    afs_analyze_12_mmx((PIXEL_YC *)dst, (PIXEL_YC *)p0, (PIXEL_YC *)p1, tb_order, step, height, motion_count, mc_clip);
}
static void __stdcall afs_analyze_1_mmx_plus2(unsigned char *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
    afs_analyze_1_mmx((PIXEL_YC *)dst, (PIXEL_YC *)p0, (PIXEL_YC *)p1, tb_order, step, height, motion_count, mc_clip);
}
static void __stdcall afs_analyze_2_mmx_plus2(unsigned char *dst, void *p0, void *p1, int tb_order, int width, int step, int si_pitch, int h_start, int h_fin, int height, int h_max, int *motion_count, AFS_SCAN_CLIP *mc_clip) {
    afs_analyze_2_mmx((PIXEL_YC *)dst, (PIXEL_YC *)p0, (PIXEL_YC *)p1, tb_order, step, height, motion_count, mc_clip);
}
#ifdef __cplusplus
}
#endif
